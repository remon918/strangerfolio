...
const About = () => {
  return (
    <section className="text-white mb-20 scroll-mt-10" id="about">
      {/* Section Title */}
      <div className="text-center">
        <h2 className="text-3xl font-bold mb-8 uppercase tracking-widest border-b-2 border-purple-600 inline-block mx-auto w-fit">
          About Me
        </h2>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12 mb-10">
          <div className="flex items-center space-x-2">
            ...
            <p>
              <span className="font-bold">Website:</span> www.strangerfolio.com
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
            <p>
              <span className="font-bold">Degree:</span> Computer Science
              (Student)
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
            <p>
              <span className="font-bold">Phone:</span> +880 13195 71230
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
          ...
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
            <p>
              <span className="font-bold">City:</span> Dhaka, Bangladesh
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
          ...
          {/* New Info from image_1da0d2.png */}
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
            <p>
              <span className="font-bold">Focus:</span> BackEnd Development
            </p>
          </div>
          <div className="flex items-center space-x-2">
            <span className="text-purple-500 font-bold text-xl">›</span>
            <p>
              ...
              <span className="text-green-400 ml-1">Available for Hire</span>
            </p>
          </div>
        </div>

        {/* Closing Description */}
        <p className="text-gray-300 leading-relaxed border-l-4 border-purple-600 pl-4 bg-white/5 py-4 shadow-lg">
